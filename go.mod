...
require (
	...
	github.com/forbole/juno/v3 v3.0.0-20220505031330-f5ce342c5a79
...
replace (
	github.com/cosmos/cosmos-sdk => github.com/huichiaotsou/cosmos-sdk v0.42.9-likecoin-removeprefixcheck
